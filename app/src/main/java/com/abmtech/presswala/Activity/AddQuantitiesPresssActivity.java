...
import static com.abmtech.presswala.Activity.AddQuantitiesDryCleanActivity.getMonth;
...
import com.abmtech.presswala.databinding.ActivityAddQuantitiesPresssBinding;
...
public class AddQuantitiesPresssActivity extends AppCompatActivity implements ProductSelect {
    ActivityAddQuantitiesPresssBinding binding;
    Activity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddQuantitiesPresssBinding.inflate(getLayoutInflater());
        ...
        database.getReference().child("products").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    if (model.getProductType().equalsIgnoreCase("Press"))
                        productModelList.add(model);
                }
                binding.recyclerView.setLayoutManager(new LinearLayoutManager(activity));
                adapter = new ProductAdapter(activity, productModelList, AddQuantitiesPresssActivity.this);
